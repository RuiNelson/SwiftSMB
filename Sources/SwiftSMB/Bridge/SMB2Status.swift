...
enum SMB2StatusSeverity: UInt32, Equatable {
    case success = 0x0000_0000
    case info = 0x4000_0000
    case warning = 0x8000_0000
    case error = 0xC000_0000

    fileprivate static let mask: UInt32 = 0xC000_0000
}

enum SMB2Status: UInt32, CaseIterable, CustomStringConvertible {
    case success = 0x0000_0000
    ...
    var severity: SMB2StatusSeverity {
        SMB2StatusSeverity(rawValue: rawValue & SMB2StatusSeverity.mask)!
    }
