...
public extension SMB {
    ...
    struct Share: Equatable, Hashable, CustomDebugStringConvertible, Sendable {
        ...
        public enum Kind: Equatable, Hashable, CustomDebugStringConvertible, Sendable {
            ...
            init(_ bridgeValue: Bridge.ShareKind) {
                switch bridgeValue {
                case .diskTree:
                    self = .diskTree
                case .printQueue:
        ...
        public struct Attributes: OptionSet, Equatable, Hashable, CustomDebugStringConvertible, Sendable {
            ...
            public static let temporary = Attributes(rawValue: Bridge.ShareAttributes.temporary.rawValue)

            /// The share is hidden.
            public static let hidden = Attributes(rawValue: Bridge.ShareAttributes.hidden.rawValue)
        ...
        init(_ bridgeValue: Bridge.Share) {
    ...
    enum NodeType: Equatable, CustomDebugStringConvertible, Sendable {
        ...
        init(_ bridgeValue: Bridge.NodeType) {
            switch bridgeValue {
            case .file:
                self = .file
            case .directory:
    ...
    struct Stat: Equatable, CustomDebugStringConvertible, Sendable {
        ...
        init(_ bridgeValue: Bridge.Stat) {
    ...
    /// File attributes reported by an SMB server.
    struct FileAttributes: OptionSet, Equatable, Hashable, CustomDebugStringConvertible, Sendable {
        /// The raw attribute bitfield.
        public let rawValue: UInt32
    ...
    struct DirectoryEntry: Equatable, CustomDebugStringConvertible, Sendable {
        ...
        init(_ bridgeValue: Bridge.DirectoryEntry) {
            name = bridgeValue.name
